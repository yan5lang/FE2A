...
public class MediaMuxerRunnable extends Thread {
    ...
    public static void addVideoFrameBitmap(Bitmap bitmap) {
        if (mediaMuxerThread != null) {
            mediaMuxerThread.addVideoBitmap(bitmap);
        }
    }
    ...
    private void initMuxer() {
        ...
        videoThread = new VideoRunnable(IMAGE_WIDTH, IMAGE_HEIGHT, new WeakReference<MediaMuxerRunnable>(this));
    ...
    private void addVideoBitmap(Bitmap data) {
        if (videoThread != null) {
            videoThread.add(data);
        }
    }
